...
package.loaded["awful.hotkeys_popup.keys.tmux"] = {} --remove tmux hotkeys
...
awful.screen.connect_for_each_screen(function(s)
  ...
  awful.tag({ "1main", "2web", "3misc", "4misc", "5misc", "6read", "7zot", "8mail", "9log" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
  ...
  awful.key({ modkey, "Mod1" }, "l", function() awful.spawn("alacritty -e nvim /home/jk/notes/index.md") end,
    { description = "open Logseq", group = "launcher" }),
  awful.key({ modkey, "Mod1" }, "k", function() awful.spawn("alacritty -e joshuto") end,
    { description = "open terminal browser", group = "launcher" }),
...
awful.rules.rules = {
  ...
  -- Place Makie plot windows always in the top right corner, ontop of other
  -- windows, but no focus.
  {
    rule_any = {
      instance = {
        "Makie",
  ...
  -- Set Firefox to always map on the tag named "2web" on screen 1.
  {
    rule = { class = "firefox" },
  ...
  {
    rule = { class = "Zotero" },
    properties = { tag = "7zot", switchtotag = true }
  },
  -- Set Thunderbird to always map on the tag named "8mail" on screen 1.
  {
    rule = { class = "thunderbird" },
    properties = { tag = "8mail", switchtotag = true }
  },
  -- Set Logseq to tag "9log"
  {
    rule = { class = "Logseq" },
    properties = { tag = "9log", switchtotag = true }
  },
}
-- }}}
